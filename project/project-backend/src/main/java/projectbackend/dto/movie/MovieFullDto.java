...
//    @NotNull(message = "Vui lòng chọn chọn thể loại")
    ...
    private List<ShowTimesDto> showTimeDto;
    ...
    public List<ShowTimesDto> getShowTimeDto() {
        return showTimeDto;
    }

    public void setShowTimesDto(List<ShowTimesDto> showTimesDto) {
        this.showTimeDto = showTimesDto;
    }
    ...
    public void setShowTimeDto(List<ShowTimesDto> showTimeDto) {
