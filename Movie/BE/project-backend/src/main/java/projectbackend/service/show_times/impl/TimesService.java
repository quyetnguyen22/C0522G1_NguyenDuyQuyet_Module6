...
public class TimesService implements ITimesService {
    ...
    @Override
    public List<ITimeDto> getTime(String startDate, String endDate, Integer room) {
        return timesRepository.getTime(startDate, endDate, room);
    }

    public List<Times> getAllTime() {
