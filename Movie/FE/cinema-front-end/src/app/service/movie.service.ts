...
export class MovieService {
  ...
  saveMovie(movie: IMovieDto): Observable<IMovieDto> {
    console.log(this.URL_API + 'movie/add', movie);
    return this.httpClient.post<IMovieDto>(this.URL_API + '/movie/add', movie);
  }

  editMovie(movie: IMovieDto): Observable<IMovieDto> {
    console.log(this.URL_API + '/movie/edit/' + movie.id, movie);
    return this.httpClient.patch<IMovieDto>(this.URL_API + '/movie/edit/' + movie.id, movie);
  }
