...
export class AddMovieComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getAllRoom();
    this.image = 'https://firebasestorage.googleapis.com/v0/b/cinema-project-6158f.appspot.com/o/' +
      'Movie%2F21-11-2022095019PMcinema.png?alt=media&token=6b6f3a33-e139-4601-8dc5-b1bc94af6ad6';
  ...
  getInfo() {
    ...
    const startDate = this.formAddMovie.value.dateGroup.startDay;
    const endDate = this.formAddMovie.value.dateGroup.endDay;
    console.log(id, endDate);
    this.timeService.getTime(id, startDate, endDate).subscribe(value => {
      this.timeList = value;
      console.log(value);
    });
  }
    ...
    this.storage.upload(destinationFilename, this.selectedImage).snapshotChanges().pipe(
      finalize(() => {
        fileRef.getDownloadURL().subscribe((url) => {
          ...
          this.image = this.movieObj.image;
