...
insert into cosmetic (name, volume, price, gender, brand_id, cos_type_id, producer_id, descriptions, using_product) values ('Acetaminophen, Dextromethorphan HBr and Phenylephrine HCL', 35, 3414128, 3, 7, 3, 10, 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.');
...
insert into cosmetic (name, volume, price, gender, brand_id, cos_type_id, producer_id, descriptions, using_product) values ('Imipenem and Cilastatin Sodium', 145, 2177694, 1, 5, 3, 3, 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.');
insert into cosmetic (name, volume, price, gender, brand_id, cos_type_id, producer_id, descriptions, using_product) values ('Octinoxate and Oxybenzone', 35, 1071400, 1, 1, 3, 10, 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.');
...
insert into cosmetic (name, volume, price, gender, brand_id, cos_type_id, producer_id, descriptions, using_product) values ('Zinc Oxide, Ethylhexyl Methoxycinnamate, Benzophenone, Ethylhexyl Salicylate', 40, 4603047, 2, 7, 6, 5, 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.');
insert into cosmetic (name, volume, price, gender, brand_id, cos_type_id, producer_id, descriptions, using_product) values ('Butalbital and Acetaminophen Tablets', 139, 3935792, 1, 1, 8, 2, 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.');
